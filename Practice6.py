...
product = []
while input("Хотите добавить новый товар? Введите да/нет: ") == 'да':
    number = int(input("Введите номер товара: "))
    features = {}
    while input("Хотите добавить параметры товара? Введите да/нет: ") == 'да':
        feature_key = input("Введите тип товара: ")
        feature_value = input("Введите характеристики товара: ")
        features[feature_key] = feature_value
    product.append(tuple([number, features]))
print(product)
